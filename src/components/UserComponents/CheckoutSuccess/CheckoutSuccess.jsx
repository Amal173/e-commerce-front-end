...
function CheckoutSuccess() {
  ...
  return (
    ...
    <svg class="checkmark__background" height="115" viewBox="0 0 120 115" width="120" xmlns="http://www.w3.org/2000/svg">
      ...
      <h4>Payment Done Succesfully</h4>
      <button onClick={() =>navigate('/order-success' ,{state:{cartItems:parsedData,id:id}})}>go to order Details <i class="fa-solid fa-arrow-right"></i></button>
    </div>
  )
}
